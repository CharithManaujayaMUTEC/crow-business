...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->string('number')->unique(); $table->string('status')->default('issued');
            $table->date('issued_at')->nullable(); $table->date('due_at')->nullable();
            ...
            $table->decimal('balance',12,2)->default(0); $table->text('notes')->nullable(); $table->timestamps();
